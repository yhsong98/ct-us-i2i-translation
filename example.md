...
python sepdata.py --dataroot ./datasets/maps --name maps_cyclegan --model cycle_gan
```
...
python sepdata.py --dataroot ./datasets/facades --name facades_pix2pix --model pix2pix --direction BtoA
```
...
```bash
python sepdata.py --dataroot datasets/horse2zebra/testA --name horse2zebra_pretrained --model test --no_dropout
```
...
- Then generate the results using
```bash
python sepdata.py --dataroot ./datasets/facades/ --direction BtoA --model pix2pix --name facades_label2photo_pretrained
```
